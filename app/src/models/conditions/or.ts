...
{
  public description = "Any condition must be true";
  public example =
    "If asset is sold to open or the price is above the buy price, ...";
  public type = ConditionEnum.OrCondition;

  constructor(obj?: ICompoundCondition) {
    super({ ...obj, type: ConditionEnum.OrCondition });
  }
